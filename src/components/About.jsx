...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row justify-center items-center md:px-32 px-5 bg-white gap-12">
      ...
      >
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          Embark on a journey of discovery, relaxation, and adventure with us.
          At <span className="font-semibold text-black">Tour Bazz</span>, we
          promise an unforgettable experience where every detail is tailored to
          your perfect trip.
        </p>
